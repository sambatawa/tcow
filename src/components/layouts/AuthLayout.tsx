...
export function AuthLayout({ children }: AuthLayoutProps) {
  ...
  return (
    <div className="min-h-screen w-full bg-brand-cream/50 dark:bg-[#12180e] overflow-x-hidden overflow-y-auto relative">
      ...
      <div className={`hidden lg:flex w-[200%] min-h-screen transition-transform duration-700 ease-in-out ${isRegister ? "auth-slider-register" : "auth-slider-login"}`}>
        <div className="w-1/2 min-h-screen flex">
          <div className="w-[46%] min-h-screen flex flex-col justify-between relative overflow-hidden p-10 xl:p-12 landing-gradient-panel text-brand-cream">
          ...
          <div className="flex-1 min-h-screen flex items-center justify-center p-10 bg-brand-cream/50 dark:bg-[#12180e]">
        ...
        <div className="w-1/2 min-h-screen flex flex-row-reverse">
          <div className="w-[46%] min-h-screen flex flex-col justify-between relative overflow-hidden p-10 xl:p-12 landing-gradient-panel text-brand-cream">
            <div aria-hidden className="pointer-events-none absolute inset-0 opacity-[0.12]"/>
            ...
            <div className="relative space-y-8 max-w-lg">
              <div>
                <p className="text-brand-accent/95 text-xs font-semibold uppercase tracking-[0.2em] mb-4">T-Cow° : Temperature Cow Celcius</p>
                <h1 className="text-3xl xl:text-[2.1rem] font-bold leading-snug">Gunakan T-Cow° untuk meningkatkan produktivitas dan kesehatan ternak Anda.</h1>
                <p className="mt-4 text-brand-cream/85 text-[15px] leading-relaxed">Daftarkan akun Anda untuk akses monitoring kesehatan sapi secara real-time.</p>
              </div>
              <dl className="grid grid-cols-2 gap-3 text-[13px]">
                <div className="rounded-xl border border-brand-cream/20 bg-brand-forest/25 backdrop-blur-md px-4 py-3">
                  <dt className="text-brand-tan font-medium">Akses peran</dt>
                  <dd className="text-brand-cream/90 mt-0.5">Peternak (Full akses dashboard) &amp; Publik (Read-only homeweb)</dd>
                </div>
                <div className="rounded-xl border border-brand-cream/20 bg-brand-forest/25 backdrop-blur-md px-4 py-3">
                  <dt className="text-brand-tan font-medium">Flexible</dt>
                  <dd className="text-brand-cream/90 mt-0.5">Akses di ponsel? tetap sama datanya!</dd>
                </div>
              </dl>
            </div>
